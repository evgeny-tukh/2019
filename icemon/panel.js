...
LeftPane.prototype.onInitialize = function ()
{
    ...
    function queryData ()
    {
        ...
        url = 'http://maps.kosmosnimki.ru/rest/ver1/layers/EB271FC4D2AD425A9BAA78ADEA041AB9/search?&apikey=4WYFYJC5X0&query=[acqdate]>=\'' +
              //'http://maps.kosmosnimki.ru/rest/ver1/layers/EB271FC4D2AD425A9BAA78ADEA041AB9/search?&apikey=4WYFYJC5X0&query=[DateTime]>\'' +
              dt.getFullYear () + '-' + (dt.getMonth () + 1) +  '-' + (dt.getDate () + 0) + '\' and [acqdate]<\'' + dt.getFullYear () + '-' + (dt.getMonth () + 1) +  '-' + 
